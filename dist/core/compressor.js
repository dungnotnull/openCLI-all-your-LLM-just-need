 ...
 */
export async function compressSession(messages, providerId, strategy) {
    // Count total tokens
 ...
 */
async function slidingWindowCompression(messages, providerId, strategy) {
    const result = [];
    let currentTokens = 0;
 ...
 */
async function semanticCompression(messages, providerId, strategy) {
    const result = [];
    let currentTokens = 0;
    // Always keep system prompt
    const systemMessage = messages.find(m => m.role === 'system');
 ...
 */
async function adaptiveCompression(messages, providerId, strategy) {
 ...
 */
function createToolResultSummary(toolResults) {
 ...
 */
export async function calculateCompressionMetrics(before, after, providerId) {
 ...
 */
export function getDefaultCompressionStrategy(providerId, contextWindow) {
