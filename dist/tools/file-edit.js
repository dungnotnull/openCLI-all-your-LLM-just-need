...
export class FileEditTool extends Tool {
    name = "file_edit";
    description = "Edit a file using simple text replacement or append";
    inputSchema = {
        type: "object",
        properties: {
            filePath: {
            ...
            patch: {
                type: "string",
                description: "Patch operation: Use 'old_text >>>> new_text' for replacement, or '>>> content' to append",
            },
        },
    ...
    async execute(input) {
        ...
        if (!parsed) {
            return {
                ...
                content: "Invalid input: filePath and patch are required (filePath and patch must be strings)",
                isError: true,
            };
        }
     ...
     */
    applyPatch(currentContent, patch) {
