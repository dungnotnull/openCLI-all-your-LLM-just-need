 ...
 */
export async function handleMultiAgentCommand(args, context) {
 ...
 */
function formatMultiAgentStatus() {
    const lines = [];
 ...
 */
export function updateMultiAgentStats(tasksCompleted, costSavings) {
 ...
 * Get current state
 */
export function getMultiAgentState() {
    return { ...state };
}
