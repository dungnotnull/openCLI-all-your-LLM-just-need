 ...
 */
export async function showCostDashboard(options = {}) {
    ...
    if (providerSummary.length > 0) {
        ...
        for (const summary of providerSummary) {
            ...
            console.log(`   ${providerName.padEnd(15)} ` +
 ...
 */
export async function exportCosts(options = {}) {
    const tracker = new EnhancedCostTracker();
    try {
        await tracker.loadFromStorage();
    }
 ...
 */
export function setupCostCommand(program) {
