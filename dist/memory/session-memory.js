...
export class SessionManager {
     ...
     */
    constructor(provider, model, existingSession) {
    ...
    isComplete() {
        ...
        if (hasStopReason) {
            return (lastMessage.role === "assistant" &&
                lastMessage.stopReason === "end_turn");
        }
    ...
    async compressIfNeeded() {
        ...
        const strategy = this.customCompressionStrategy || getDefaultCompressionStrategy(this.provider.id, this.model.contextWindow);
     ...
     */
    static deserialize(data, provider, model) {
