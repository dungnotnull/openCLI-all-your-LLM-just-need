 ...
 */
export async function parseContent(content, options = {}) {
    const { maxContentLength = 10000, includeFullText = false, } = options;
 ...
 */
export async function parseBatch(contents, options = {}) {
    const results = [];
 ...
 */
export function generateParsingPrompt(content) {
