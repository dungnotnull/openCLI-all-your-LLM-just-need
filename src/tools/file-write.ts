...
export class FileWriteTool extends Tool {
  ...
  async execute(input: Record<string, unknown>): Promise<ToolResult> {
    ...
    if (!parsed) {
      return {
        ...
        content:
          "Invalid input: filePath and content are required (filePath and content must be strings)",
        isError: true,
      };
    }
   ...
   */
  private parseInput(input: Record<string, unknown>): FileWriteInput | null {
